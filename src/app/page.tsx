            ...
            <div className="max-w-2xl w-full">
                <div className="text-center mb-12">
                    ...
                    <p className="text-[#616161]/70 text-lg">
                        Developer tools for testing PayPal Pay Later
                        integrations
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <p className="text-[#616161]/80 text-sm leading-relaxed">
                            Batch-test Pay Later eligibility across 8 countries
                            via API. Get instant HTTP status results without
                    ...
                    >
                        ...
                        <p className="text-[#616161]/80 text-sm leading-relaxed">
                            Simulated checkout page with dynamic Pay Later
                            availability. Switch buyer country to see real-time
                            SDK eligibility and payment button rendering.
                        </p>
                        <div className="mt-6 text-[#6200ee] text-sm font-medium group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                            Open demo →
                        </div>
                    ...
                    >
                        ...
                        <p className="text-[#616161]/80 text-sm leading-relaxed">
                            Upload a CSV with multiple client IDs and countries
                            to batch-check Pay Later eligibility. Download
                            results as CSV. Live environment only.
                        </p>
                        <div className="mt-6 text-[#6200ee] text-sm font-medium group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                            Open tool →
                        </div>
